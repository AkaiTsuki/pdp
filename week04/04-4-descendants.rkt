...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 04-1-descendants) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(define-test-suite descendants-tests
  (check-equal? (descendants fred) (list chuck eddie alice bob dave))
  (check-equal? (all-descendants (list chuck eddie)) (list alice bob dave)))
