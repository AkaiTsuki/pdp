...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 01-3-traffic-light) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(require rackunit)
...
;; produces the TLState that follows the given TLState
...
;; given a TLState, returns the state that preceded it
