...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 02-2-draggable-cat) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
;; draggable cat.
...
;; given a position and paused?, produces the next World
...
;; produce the world following a button-down at the given location.
...
;; produce the world following a drag at the given location.
...
;; produce the world following a button-up at the given location.
