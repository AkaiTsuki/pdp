...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname falling-cat) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
;; falling cat.  
...
;; main : Number -> World
;; start the simulation with the cat in the given y-position and falling.
